...
##
## Debug
ProjectName            :=robotarm
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/Hampus/Desktop/DAT017/CodeLite
ProjectPath            :=C:/Users/Hampus/Desktop/DAT017/CodeLite/robotarm
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/robotarm.elf ./Debug/robotarm.s19
	arm-none-eabi-objdump -D -S ./Debug/robotarm.elf > ./Debug/robotarm.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Hampus/Desktop/DAT017/CodeLite/robotarm/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
