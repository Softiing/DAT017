  ...
  25              		.file 1 "C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong/startup.c"
   ...
   7:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** //#define SIMULATOR
   8:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 
   9:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** void startup(void) __attribute__((naked)) __attribute__((section (".start_section")) );
  10:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 
  11:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** void startup ( void )
  12:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** {
  26              		.loc 1 12 0
  27              		.cfi_startproc
  28              		@ Naked Function: prologue and epilogue provided by programmer.
  29              		@ args = 0, pretend = 0, frame = 0
  30              		@ frame_needed = 1, uses_anonymous_args = 0
  13:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** __asm volatile(
  31              		.loc 1 13 0
  32              		.syntax divided
  33              	@ 13 "C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong/startup.c" 1
  ...
  38              	
  39              	@ 0 "" 2
  14:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	" LDR R0,=0x2001C000\n"		/* set stack */
  15:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	" MOV SP,R0\n"
  16:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	" BL main\n"				/* call main */
  17:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	"_exit: B .\n"				/* never return */
  ...
  55              	init_app:
  56              	.LFB1:
  20:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 
  21:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** void init_app(void) {
  57              		.loc 1 21 0
  58              		.cfi_startproc
  ...
  22:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	// Setup display
  23:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	*GPIO_E_MODER = 0x55555555;
  67              		.loc 1 23 0
  68 0004 0B4B     		ldr	r3, .L3
  69 0006 0C4A     		ldr	r2, .L3+4
  70 0008 1A60     		str	r2, [r3]
  24:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	
  25:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	// Setup for keypad
  26:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	*GPIO_D_MODER = 0x55000000;
  71              		.loc 1 26 0
  72 000a 0C4B     		ldr	r3, .L3+8
  73 000c AA22     		movs	r2, #170
  74 000e D205     		lsls	r2, r2, #23
  75 0010 1A60     		str	r2, [r3]
  27:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	*GPIO_D_OTYPER &= 0x0000FFFF;   
  76              		.loc 1 27 0
  ...
  28:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	*GPIO_D_OTYPER |= 0x00000000;     
  82              		.loc 1 28 0
  ...
  29:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	*GPIO_D_PUPDR = 0x00AA0000;    
  88              		.loc 1 29 0
 ...
 117              	.LFB2:
  ...
  33:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 
  34:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** extern OBJECT ball;
  35:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** extern OBJECT leftPaddle;
  36:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** extern OBJECT rightPaddle;
  37:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 
  38:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** void main(void) {
 118              		.loc 1 38 0
 119              		.cfi_startproc
 ...
 129              		.cfi_def_cfa_register 7
  39:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	POBJECT p = &ball;
 130              		.loc 1 39 0
 131 004e 374B     		ldr	r3, .L15
 132 0050 3B61     		str	r3, [r7, #16]
  40:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	POBJECT pl = &leftPaddle;
 133              		.loc 1 40 0
 134 0052 374B     		ldr	r3, .L15+4
 135 0054 FB60     		str	r3, [r7, #12]
  41:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	POBJECT pr = &rightPaddle;
 136              		.loc 1 41 0
 137 0056 374B     		ldr	r3, .L15+8
 138 0058 BB60     		str	r3, [r7, #8]
  42:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	init_app();
 139              		.loc 1 42 0
 140 005a FFF7FEFF 		bl	init_app
  43:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	graphic_initialize();
 141              		.loc 1 43 0
 142 005e FFF7FEFF 		bl	graphic_initialize
  44:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c ****   #ifndef SIMULATOR
  45:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 	graphic_clear_screen();
 143              		.loc 1 45 0
 144 0062 FFF7FEFF 		bl	graphic_clear_screen
 145              	.L14:
 146              	.LBB2:
  46:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c ****   #endif
  47:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c ****   
 ...
 192 00ae 16D0     		beq	.L12
 193 00b0 1DE0     		b	.L7
 194              	.L10:
  56:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 				case 0x01: pl->set_speed(pl,0,10); break;
 195              		.loc 1 56 0
 196 00b2 FB68     		ldr	r3, [r7, #12]
 197 00b4 1B6A     		ldr	r3, [r3, #32]
 198 00b6 F868     		ldr	r0, [r7, #12]
 199 00b8 0A22     		movs	r2, #10
 200 00ba 0021     		movs	r1, #0
 201 00bc 9847     		blx	r3
 202              	.LVL2:
 203 00be 16E0     		b	.L7
 204              	.L8:
  57:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 				case 0x04: pl->set_speed(pl,0,-10); break;
 205              		.loc 1 57 0
 206 00c0 FB68     		ldr	r3, [r7, #12]
 207 00c2 1B6A     		ldr	r3, [r3, #32]
 208 00c4 0A22     		movs	r2, #10
 209 00c6 5242     		rsbs	r2, r2, #0
 210 00c8 F868     		ldr	r0, [r7, #12]
 211 00ca 0021     		movs	r1, #0
 212 00cc 9847     		blx	r3
 213              	.LVL3:
 214 00ce 0EE0     		b	.L7
 215              	.L11:
  58:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 				case 0x0C: pr->set_speed(pr,0,10); break;
 216              		.loc 1 58 0
 217 00d0 BB68     		ldr	r3, [r7, #8]
 218 00d2 1B6A     		ldr	r3, [r3, #32]
 219 00d4 B868     		ldr	r0, [r7, #8]
 220 00d6 0A22     		movs	r2, #10
 221 00d8 0021     		movs	r1, #0
 222 00da 9847     		blx	r3
 223              	.LVL4:
 224 00dc 07E0     		b	.L7
 225              	.L12:
  59:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 				case 0x0D: pr->set_speed(pr,0,-10); break;
 226              		.loc 1 59 0
 227 00de BB68     		ldr	r3, [r7, #8]
 228 00e0 1B6A     		ldr	r3, [r3, #32]
 229 00e2 0A22     		movs	r2, #10
 230 00e4 5242     		rsbs	r2, r2, #0
 231 00e6 B868     		ldr	r0, [r7, #8]
 ...
 237              		.loc 1 54 0 discriminator 2
 ...
 245              	.L6:
  54:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 			switch(pressedKeys[i]) {
 246              		.loc 1 54 0 is_stmt 0 discriminator 1
 ...
 252              	.LBE3:
  ...
  62:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 		p->move(p);
 253              		.loc 1 62 0 is_stmt 1
 ...
 259              	.LVL6:
  63:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 		pl->move(pl);
 260              		.loc 1 63 0
 ...
 266              	.LVL7:
  64:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 		pr->move(pr);
 267              		.loc 1 64 0
 ...
 273              	.LVL8:
  65:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\startup.c **** 		delay_milli(50);
 274              		.loc 1 65 0
