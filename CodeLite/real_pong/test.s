 ...
 297 002c 0EE0     		b	.L3
 298              	.L2:
  64:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\paddle.c **** 	} else if((this->posY + this->geo->sizeY) > 63) {
 299              		.loc 1 64 0
 ...
 306 003a 3F2B     		cmp	r3, #63
 307 003c 06DD     		ble	.L3
  65:C:/Users/Hampus/Desktop/DAT017/CodeLite/real_pong\paddle.c **** 		this->posY = (63 - this->geo->sizeY);
 308              		.loc 1 65 0
 309 003e 7B68     		ldr	r3, [r7, #4]
 310 0040 1B68     		ldr	r3, [r3]
 311 0042 9B68     		ldr	r3, [r3, #8]
 312 0044 3F22     		movs	r2, #63
